...
import com.sclouds.common.task.TaskExecutor;
import com.sclouds.datasource.of.utils.L;
                    ...
                    for (int i = 0; i < observerList.size(); ++i) {
                        ...
                        if (callback == null) {
                            ...
                            if (isMainThread()){
                                ...
                                TaskExecutor.INSTANCE.executeRunOnUIExecutorTask(new Runnable() {
                                    @Override
                                    public void run() {
                                        try {
                            ...
                            L.INSTANCE.e("chowen#onMessage>>referenceCount>>" + message.referenceCount + ">>type=" + message.type);
                            // FIXME: 2020/4/8 by zhouwen
