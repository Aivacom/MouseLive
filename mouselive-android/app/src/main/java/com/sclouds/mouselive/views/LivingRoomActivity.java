...
public class LivingRoomActivity
    ...
    private EffectPanDialog mEffectPanDialog;

    /**
     * 显示美颜特效窗口
     */
    public void showEffectDialog() {
        if (mEffectPanDialog == null) {
            mEffectPanDialog = new EffectPanDialog();
        }
        mEffectPanDialog.show(getSupportFragmentManager());
