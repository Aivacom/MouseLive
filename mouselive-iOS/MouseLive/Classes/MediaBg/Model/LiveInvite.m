...
@property (nonatomic, assign) WSRoomType roomType;
...
- (instancetype)initWithDelegate:(id<LiveInviteDelegate>)delegate uid:(NSString *)uid roomid:(NSString *)roomid roomType:(WSRoomType)roomType
{
    if (self = [super init]) {
